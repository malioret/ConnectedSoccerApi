...
class appTestDebugProjectContainer extends Container
{
     ...
     *
     * @return \SubwayBuddy\UserBundle\Admin\UserAdmin A SubwayBuddy\UserBundle\Admin\UserAdmin instance.
     */
    protected function getAdmin_CustomerService()
    {
        $instance = new \SubwayBuddy\UserBundle\Admin\UserAdmin('admin.customer', 'SubwayBuddy\\UserBundle\\Entity\\User', 'SonataAdminBundle:CRUD');
    ...
    protected function getDoctrine_Orm_DefaultEntityManagerService()
    {
        ...
        $b = new \Doctrine\ORM\Mapping\Driver\AnnotationDriver($a, array(0 => ($this->targetDirs[3].'/src/SubwayBuddy/UserBundle/Entity'), 1 => ($this->targetDirs[3].'/src/Soccer/EventBundle/Entity'), 2 => ($this->targetDirs[3].'/src/Soccer/TeamBundle/Entity')));

        $c = new \Doctrine\Common\Persistence\Mapping\Driver\MappingDriverChain();
        $c->addDriver($b, 'SubwayBuddy\\UserBundle\\Entity');
        ...
        $d->setEntityNamespaces(array('SubwayBuddyUserBundle' => 'SubwayBuddy\\UserBundle\\Entity', 'SoccerEventBundle' => 'Soccer\\EventBundle\\Entity', 'SoccerTeamBundle' => 'Soccer\\TeamBundle\\Entity'));
    ...
    {
        return $this->services['fos_user.change_password.form.type'] = new \FOS\UserBundle\Form\Type\ChangePasswordFormType('SubwayBuddy\\UserBundle\\Entity\\User');
    }
    ...
    {
        return $this->services['fos_user.profile.form.type'] = new \FOS\UserBundle\Form\Type\ProfileFormType('SubwayBuddy\\UserBundle\\Entity\\User');
    }
    ...
    {
        return $this->services['fos_user.registration.form.type'] = new \FOS\UserBundle\Form\Type\RegistrationFormType('SubwayBuddy\\UserBundle\\Entity\\User');
    }
    ...
    {
        return $this->services['fos_user.resetting.form.type'] = new \FOS\UserBundle\Form\Type\ResettingFormType('SubwayBuddy\\UserBundle\\Entity\\User');
    }
    ...
    protected function getFosUser_UserManagerService()
    {
        ...
        return $this->services['fos_user.user_manager'] = new \FOS\UserBundle\Doctrine\UserManager($this->get('security.encoder_factory'), $a, $a, $this->get('doctrine')->getManager(NULL), 'SubwayBuddy\\UserBundle\\Entity\\User');
    }
    ...
    {
        $a = new \Metadata\Driver\FileLocator(array('Symfony\\Bundle\\FrameworkBundle' => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Bundle/FrameworkBundle/Resources/config/serializer'), 'Symfony\\Bundle\\SecurityBundle' => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Bundle/SecurityBundle/Resources/config/serializer'), 'Symfony\\Bundle\\TwigBundle' => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Bundle/TwigBundle/Resources/config/serializer'), 'Symfony\\Bundle\\MonologBundle' => ($this->targetDirs[3].'/vendor/symfony/monolog-bundle/Resources/config/serializer'), 'Symfony\\Bundle\\SwiftmailerBundle' => ($this->targetDirs[3].'/vendor/symfony/swiftmailer-bundle/Resources/config/serializer'), 'Symfony\\Bundle\\AsseticBundle' => ($this->targetDirs[3].'/vendor/symfony/assetic-bundle/Resources/config/serializer'), 'Doctrine\\Bundle\\DoctrineBundle' => ($this->targetDirs[3].'/vendor/doctrine/doctrine-bundle/Resources/config/serializer'), 'Sensio\\Bundle\\FrameworkExtraBundle' => ($this->targetDirs[3].'/vendor/sensio/framework-extra-bundle/Resources/config/serializer'), 'SubwayBuddy\\UserBundle' => ($this->targetDirs[3].'/src/SubwayBuddy/UserBundle/Resources/config/serializer'), 'FOS\\UserBundle' => ($this->targetDirs[3].'/src/SubwayBuddy/UserBundle/Resources/config/serializer/FOSUB'), 'Sonata\\CoreBundle' => ($this->targetDirs[3].'/vendor/sonata-project/core-bundle/Resources/config/serializer'), 'Sonata\\BlockBundle' => ($this->targetDirs[3].'/vendor/sonata-project/block-bundle/Resources/config/serializer'), 'Knp\\Bundle\\MenuBundle' => ($this->targetDirs[3].'/vendor/knplabs/knp-menu-bundle/Resources/config/serializer'), 'Sonata\\DoctrineORMAdminBundle' => ($this->targetDirs[3].'/vendor/sonata-project/doctrine-orm-admin-bundle/Resources/config/serializer'), 'Sonata\\AdminBundle' => ($this->targetDirs[3].'/vendor/sonata-project/admin-bundle/Resources/config/serializer'), 'JMS\\SerializerBundle' => ($this->targetDirs[3].'/vendor/jms/serializer-bundle/JMS/SerializerBundle/Resources/config/serializer'), 'FOS\\RestBundle' => ($this->targetDirs[3].'/vendor/friendsofsymfony/rest-bundle/FOS/RestBundle/Resources/config/serializer'), 'Soccer\\EventBundle' => ($this->targetDirs[3].'/src/Soccer/EventBundle/Resources/config/serializer'), 'Soccer\\LandingBundle' => ($this->targetDirs[3].'/src/Soccer/LandingBundle/Resources/config/serializer'), 'Soccer\\TeamBundle' => ($this->targetDirs[3].'/src/Soccer/TeamBundle/Resources/config/serializer'), 'Soccer\\UtilBundle' => ($this->targetDirs[3].'/src/Soccer/UtilBundle/Resources/config/serializer'), 'Symfony\\Bundle\\DebugBundle' => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Bundle/DebugBundle/Resources/config/serializer'), 'Symfony\\Bundle\\WebProfilerBundle' => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Bundle/WebProfilerBundle/Resources/config/serializer'), 'Sensio\\Bundle\\DistributionBundle' => ($this->targetDirs[3].'/vendor/sensio/distribution-bundle/Sensio/Bundle/DistributionBundle/Resources/config/serializer'), 'Sensio\\Bundle\\GeneratorBundle' => ($this->targetDirs[3].'/vendor/sensio/generator-bundle/Sensio/Bundle/GeneratorBundle/Resources/config/serializer')));
    ...
    protected function getSonata_Admin_PoolService()
    {
        ...
        $instance->setAdminClasses(array('SubwayBuddy\\UserBundle\\Entity\\User' => array(0 => 'admin.customer')));
    ...
    protected function getTwig_LoaderService()
    {
        ...
        $instance->addPath(($this->targetDirs[3].'/src/SubwayBuddy/UserBundle/Resources/views'), 'SubwayBuddyUser');
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'kernel.bundles' => array(
                ...
                'SubwayBuddyUserBundle' => 'SubwayBuddy\\UserBundle\\SubwayBuddyUserBundle',
            ...
            'fos_user.model.user.class' => 'SubwayBuddy\\UserBundle\\Entity\\User',
