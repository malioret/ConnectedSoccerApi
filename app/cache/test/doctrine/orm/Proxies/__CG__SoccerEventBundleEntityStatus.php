 ...
 */
class Status extends \Soccer\EventBundle\Entity\Status implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', 'id', '' . "\0" . 'Soccer\\EventBundle\\Entity\\Status' . "\0" . 'label');
        }
