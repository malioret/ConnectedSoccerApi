 ...
 */
class Terrain extends \Soccer\EventBundle\Entity\Terrain implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', 'id', '' . "\0" . 'Soccer\\EventBundle\\Entity\\Terrain' . "\0" . 'adresse', '' . "\0" . 'Soccer\\EventBundle\\Entity\\Terrain' . "\0" . 'longitude', '' . "\0" . 'Soccer\\EventBundle\\Entity\\Terrain' . "\0" . 'latitude');
        }
