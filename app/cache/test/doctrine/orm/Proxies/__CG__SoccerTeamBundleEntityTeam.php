 ...
 */
class Team extends \Soccer\TeamBundle\Entity\Team implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', 'id', '' . "\0" . 'Soccer\\TeamBundle\\Entity\\Team' . "\0" . 'nom', '' . "\0" . 'Soccer\\TeamBundle\\Entity\\Team' . "\0" . 'joueurs', '' . "\0" . 'Soccer\\TeamBundle\\Entity\\Team' . "\0" . 'events');
        }
     ...
     * {@inheritDoc}
     */
    public function addEvent(\Soccer\EventBundle\Entity\Event $event)
    {
