...
class ap_DevDebugProjectContainer extends Container
{
    ...
    protected function getDoctrine_Dbal_DefaultConnectionService()
    {
        ...
        return $this->services['doctrine.dbal.default_connection'] = $this->get('doctrine.dbal.connection_factory')->createConnection(array('driver' => 'pdo_mysql', 'host' => 'mathieulgtadmin.mysql.db', 'port' => NULL, 'dbname' => 'mathieulgtadmin', 'user' => 'mathieulgtadmin', 'password' => 'Root93190', 'charset' => 'UTF8', 'driverOptions' => array(), 'defaultTableOptions' => array()), $b, $c, array());
    }
    ...
    protected function getDoctrine_Orm_DefaultEntityManagerService()
    {
        ...
        $a->addDriver(new \Doctrine\ORM\Mapping\Driver\AnnotationDriver($this->get('annotation_reader'), array(0 => ($this->targetDirs[3].'/src/SubwayBuddy/UserBundle/Entity'))), 'SubwayBuddy\\UserBundle\\Entity');
        ...
        $b->setEntityNamespaces(array('SubwayBuddyUserBundle' => 'SubwayBuddy\\UserBundle\\Entity'));
    ...
    protected function getDoctrineCache_Providers_Doctrine_Orm_DefaultMetadataCacheService()
    {
        ...
        $instance->setNamespace('sf2orm_default_bd598c7ae1d233b7a872516d0acc239d2cafda805242fcddda3b81d8351db3e9');
    ...
    protected function getSecurity_Firewall_Map_Context_MainService()
    {
        ...
        $k = new \Symfony\Component\HttpFoundation\RequestMatcher('^/event/');

        $l = new \Symfony\Component\HttpFoundation\RequestMatcher('^/ae/');

        $m = new \Symfony\Component\HttpFoundation\RequestMatcher('^/client/');
        ...
        $n->add($k, array(0 => 'ROLE_EVENT'), NULL);
        $n->add($l, array(0 => 'ROLE_BS'), NULL);
        $n->add($m, array(0 => 'ROLE_CUSTOMER'), NULL);
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'database_host' => 'mathieulgtadmin.mysql.db',
            'database_port' => NULL,
            'database_name' => 'mathieulgtadmin',
            'database_user' => 'mathieulgtadmin',
            'database_password' => 'Root93190',
