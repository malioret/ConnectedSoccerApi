 ...
 */
class Profil extends \Soccer\UserBundle\Entity\Profil implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', 'id', '' . "\0" . 'Soccer\\UserBundle\\Entity\\Profil' . "\0" . 'profil');
        }
