 ...
 */
class UserEvent extends \Soccer\EventBundle\Entity\UserEvent implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', 'id', '' . "\0" . 'Soccer\\EventBundle\\Entity\\UserEvent' . "\0" . 'event', '' . "\0" . 'Soccer\\EventBundle\\Entity\\UserEvent' . "\0" . 'user', '' . "\0" . 'Soccer\\EventBundle\\Entity\\UserEvent' . "\0" . 'status');
        }
