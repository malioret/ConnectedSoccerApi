 ...
 */
class NoteEvent extends \Soccer\EventBundle\Entity\NoteEvent implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', 'id', '' . "\0" . 'Soccer\\EventBundle\\Entity\\NoteEvent' . "\0" . 'note', '' . "\0" . 'Soccer\\EventBundle\\Entity\\NoteEvent' . "\0" . 'user', '' . "\0" . 'Soccer\\EventBundle\\Entity\\NoteEvent' . "\0" . 'event');
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (NoteEvent $proxy) {
