...
namespace Proxies\__CG__\Soccer\CommentBundle\Entity;

/**
 * DO NOT EDIT THIS FILE - IT WAS CREATED BY DOCTRINE'S PROXY GENERATOR
 */
class Commentaire extends \Soccer\CommentBundle\Entity\Commentaire implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', 'id', '' . "\0" . 'Soccer\\CommentBundle\\Entity\\Commentaire' . "\0" . 'message', '' . "\0" . 'Soccer\\CommentBundle\\Entity\\Commentaire' . "\0" . 'date_creation', '' . "\0" . 'Soccer\\CommentBundle\\Entity\\Commentaire' . "\0" . 'user', '' . "\0" . 'Soccer\\CommentBundle\\Entity\\Commentaire' . "\0" . 'event', '' . "\0" . 'Soccer\\CommentBundle\\Entity\\Commentaire' . "\0" . 'match');
        }
