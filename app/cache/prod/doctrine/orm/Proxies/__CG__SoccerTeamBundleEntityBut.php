 ...
 */
class But extends \Soccer\TeamBundle\Entity\But implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', 'id', 'nombre', '' . "\0" . 'Soccer\\TeamBundle\\Entity\\But' . "\0" . 'user', '' . "\0" . 'Soccer\\TeamBundle\\Entity\\But' . "\0" . 'match', '' . "\0" . 'Soccer\\TeamBundle\\Entity\\But' . "\0" . 'event');
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (But $proxy) {
