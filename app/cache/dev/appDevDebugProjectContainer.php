...
class appDevDebugProjectContainer extends Container
{
    ...
    protected function getDoctrine_Orm_DefaultEntityManagerService()
    {
        ...
        $b = new \Doctrine\ORM\Mapping\Driver\AnnotationDriver($a, array(0 => ($this->targetDirs[3].'/src/SubwayBuddy/UserBundle/Entity'), 1 => ($this->targetDirs[3].'/src/Soccer/EventBundle/Entity')));
        ...
        $d->setEntityNamespaces(array('SubwayBuddyUserBundle' => 'SubwayBuddy\\UserBundle\\Entity', 'SoccerEventBundle' => 'Soccer\\EventBundle\\Entity'));
