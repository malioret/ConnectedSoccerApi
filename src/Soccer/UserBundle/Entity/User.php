 ...
 *
 * @ORM\Table()
 * @ORM\Entity(repositoryClass="Soccer\UserBundle\Entity\UserRepository")
 */
class User extends BaseUser
{
    ...
    /**
   * @ORM\ManyToMany(targetEntity="Soccer\UserBundle\Entity\Profil")
   */
    private $profils;
   ...
   */
     ...
     /**
   * @ORM\ManyToMany(targetEntity="Soccer\UserBundle\Entity\User")
   */
     private $amis; 
