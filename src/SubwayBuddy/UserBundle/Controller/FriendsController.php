...
class FriendsController extends FOSRestController
{
    ...
    public function postRecherchePasAmiAction(ParamFetcher $paramFetcher)
    {
        ...
        $userConnected=$em->getRepository('SubwayBuddyUserBundle:User')->findOneById($id);
        $users = $em->getRepository('SubwayBuddyUserBundle:User')->findAllUserNoFriendByUsername($id,$username);
